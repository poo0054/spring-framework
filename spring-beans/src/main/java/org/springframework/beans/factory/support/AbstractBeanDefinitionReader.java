...
public abstract class AbstractBeanDefinitionReader implements BeanDefinitionReader, EnvironmentCapable {
    ...
    public int loadBeanDefinitions(Resource... resources) throws BeanDefinitionStoreException {
        ...
        for (Resource resource : resources) {
            // XmlBeanDefinitionReader进行加载 resource
     ...
     *
     * @param location the resource location, to be loaded with the ResourceLoader (or ResourcePatternResolver) of this
     *            bean definition reader
     * @param actualResources a Set to be filled with the actual Resource objects that have been resolved during the
     *            loading process. May be {@code null} to indicate that the caller is not interested in those Resource
     *            objects.
