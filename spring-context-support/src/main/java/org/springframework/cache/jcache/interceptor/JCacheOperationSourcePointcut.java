...
/**
 * A Pointcut that matches if the underlying {@link JCacheOperationSource} has an operation for a given method.
 *
...
public abstract class JCacheOperationSourcePointcut extends StaticMethodMatcherPointcut implements Serializable {
    ...
    /**
     * Obtain the underlying {@link JCacheOperationSource} (may be {@code null}). To be implemented by subclasses.
     */
    @Nullable
