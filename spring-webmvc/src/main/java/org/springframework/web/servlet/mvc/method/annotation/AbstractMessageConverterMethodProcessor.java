...
public abstract class AbstractMessageConverterMethodProcessor extends AbstractMessageConverterMethodArgumentResolver
     ...
     * @throws HttpMediaTypeNotAcceptableException thrown when the conditions indicated by the {@code Accept} header on
     *             the request cannot be met by the message converters
     * @throws HttpMessageNotWritableException thrown if a given message cannot be written by a converter, or if the
     *             content-type chosen by the server has no compatible converter.
     */
