...
public abstract class MvcNamespaceUtils {
    ...
    /**
     * Adds an alias to an existing well-known name or registers a new instance of a {@link UrlPathHelper} under that
     * well-known name, unless already registered.
     * 
    ...
    /**
     * Adds an alias to an existing well-known name or registers a new instance of a {@link PathMatcher} under that
     * well-known name, unless already registered.
     * 
    ...
    /**
     * Registers a {@code Map<String, CorsConfiguration>} (mapped {@code CorsConfiguration}s) under a well-known name
     * unless already registered. The bean definition may be updated if a non-null CORS configuration is provided.
     * 
    ...
    public static RuntimeBeanReference registerCorsConfigurations(
        @Nullable Map<String, CorsConfiguration> corsConfigurations, ParserContext context, @Nullable Object source) {
    ...
    /**
     * Find the {@code ContentNegotiationManager} bean created by or registered with the {@code annotation-driven}
     * element.
     * 
