 ...
 * {@link org.springframework.beans.factory.xml.XmlBeanDefinitionReader}. This
 * is essentially the equivalent of
 * {@link org.springframework.context.support.GenericXmlApplicationContext} for
 * a web environment.
 *
 * <p>
 * By default, the configuration will be taken from
 * "/WEB-INF/applicationContext.xml" for the root context, and
 * "/WEB-INF/test-servlet.xml" for a context with the namespace "test-servlet"
 * (like for a DispatcherServlet instance with the servlet-name "test").
 *
 * <p>
 * The config location defaults can be overridden via the
 * "contextConfigLocation" context-param of
 * {@link org.springframework.web.context.ContextLoader} and servlet init-param
 * of {@link org.springframework.web.servlet.FrameworkServlet}. Config locations
 ...
 *
 * <p>
 * <b>For a WebApplicationContext that reads in a different bean definition
 * format, create an analogous subclass of
 * {@link AbstractRefreshableWebApplicationContext}.</b> Such a context
 * implementation can be specified as "contextClass" context-param for
...
public class XmlWebApplicationContext extends AbstractRefreshableWebApplicationContext {
	 ...
	 * method; therefore this method is just supposed to load and/or register bean
	 * definitions.
	 * <p>
