...
public class AnnotationListenerDemo {
	 ...
	 * <p>
	 * 这俩个类 如果添加<context:annotation-config/>作用也是一样的，因为：
	 * {@link ContextNamespaceHandler#init()}方法中初始化 {@link org.springframework.context.annotation.AnnotationConfigBeanDefinitionParser}
	 * {@link org.springframework.context.event.EventListenerMethodProcessor#postProcessBeanFactory(ConfigurableListableBeanFactory)}中添加{@link EventListenerFactory}找到 DefaultEventListenerFactory，
