...
final class PostProcessorRegistrationDelegate {
    ...
    public static void invokeBeanFactoryPostProcessors(ConfigurableListableBeanFactory beanFactory,
        ...
        if (beanFactory instanceof BeanDefinitionRegistry) {
             ...
             * 分离实现的 BeanDefinitionRegistryPostProcessor
            ...
            for (String ppName : postProcessorNames) {
                // 找出实现了PriorityOrdered的BeanDefinitionRegistryPostProcessor add加入
            ...
            // 找出所有实现了 BeanDefinitionRegistryPostProcessor
            postProcessorNames =
                beanFactory.getBeanNamesForType(BeanDefinitionRegistryPostProcessor.class, true, false);
            for (String ppName : postProcessorNames) {
                // 上面不存在的 并且实现了 Ordered 的
    ...
    public static void registerBeanPostProcessors(ConfigurableListableBeanFactory beanFactory,
        ...
        // 把BeanPostProcessor封装入BeanPostProcessorChecker
    ...
    /**
     * Invoke the given BeanDefinitionRegistryPostProcessor beans. 调用给定的 BeanDefinitionRegistryPostProcessor bean。
     */
    ...
    /**
     * Invoke the given BeanFactoryPostProcessor beans. 调用给定的 BeanFactoryPostProcessor bean。
     */
